...
const createServer = () => {
  ...
  app.get('/aboutme', (req, res) => {
    const shortBio = `Hi, my name is blah, and I blah blah blah!`;
    res.status(200).send(shortBio);
  });

  app.get('/favoritefoods', (req, res) => {
    const favoriteFoodsArray = ['sushi', 'pizza', 'teryaki', 'burger', 'calamari'];
    res.status(200).send(favoriteFoodsArray);
  });
